<?php 
 /*
 Template Name: Frameless Sliding Doors
 */
?>

<?php get_header(); ?>

   <main class="main" data-page="frameless-sliding-doors">
    ...
    <section class="photos">
      <div class="container">
        <?php echo generatePhotosMarkup('frameless_sliding_doors_photos') ?>
      </div>
     </section>

    <section class="process" data-stepper-type="quiz" data-quiz-type="frameless-doors">
      <div class="container">
        <h2 class="process__title title-with-margin uppercase-bold section-title  ">
         Start ordering Frameless Sliding Doors
        </h2>
